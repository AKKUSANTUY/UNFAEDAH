...
#Recoded By : Santri Cyber Santuy
#Tool Unfaedah :v
...
clear
            ...
            echo $pur"  ║ ║║║║╠╣ ╠═╣║╣  ║║╠═╣╠═╣"
            echo $pur"  ╚═╝╝╚╝╚  ╩ ╩╚═╝═╩╝╩ ╩╩ ╩"
            echo $mer"  ×××Tool Unfaedah | Santri××× $st"

lagi=1
while [ $lagi -lt 6 ];
do
echo""
echo $cy"1. Sadap WA work ni Cuk :v ";
echo $pur"====================]" 
...
echo $i"7. EXIT $st";
echo ""
echo    $mer"╭─Pilih Nomor Berapa Cuk!!? $st " 
read -p "╰─•>  " pil; 
...
"
echo ""
echo -n $cy"Ini Isi Nomor Target Cuk:"
read tr
echo "============================" | lolcat
echo -n $cy"Nah ini isi nomor lu Cuk: "
read lu
clear
echo "Sabar ajg lagi nyadap ini $tr" | lolcat
echo ""
echo $mer " Tunggu Sekitar 999menit ya tod hhh$st"
echo ""
sleep 50
